...
public interface AccountRepository extends CrudRepository<Account, Integer>{
	...
	Account findFirstByUsernameIgnoreCaseAndStatusOrderByIdDesc(String username, boolean status);

	Account findFirstByUsernameIgnoreCaseOrderByIdDesc(String username);

	Account findFirstByUsernameIgnoreCaseAndSecurityCodeOrderByIdDesc(String username, String securityCode);
